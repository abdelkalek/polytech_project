...
<head>
    ...
    <title>Your/ Resume / CV Template</title>
    ...
    <!--
        Load CSS
    -->
    <link rel="stylesheet" href="{{asset('theme/css/basic.css')}}" />
    <link rel="stylesheet" href="{{asset('theme/css/layout.css')}}" />
    <link rel="stylesheet" href="{{asset('theme/css/blogs.css')}}" />
    <link rel="stylesheet" href="{{asset('theme/css/ionicons.css')}}" />
    ...
    <!--
        Background Gradient
    -->
    <link rel="stylesheet" href="{{asset('theme/css/gradient.css')}}" />

    <!--
        Template New-Skin
    -->
    <link rel="stylesheet" href="{{asset('theme/css/new-skin/new-skin.css')}}" />
    ...
    <!--
        Template Colors
    -->
    <link rel="stylesheet" href="{{asset('theme/css/demos/demo-2-colors.css')}}" />
    ...
    <!--
        Template Dark
    -->
    <link rel="stylesheet" href="{{asset('theme/css/new-skin/classic-skin.css')}}" />
    <link rel="stylesheet" href="{{asset('theme/css/template-dark/dark.css')}}" />
    ...
    <!--
        Favicons
    -->
    <link rel="shortcut icon" href="{{asset('theme/images/favicons/favicon.ico')}}">
...
<div class="page new-skin">
    ...
    <div class="container opened" data-animation-in="fadeInLeft" data-animation-out="fadeOutLeft">
        ...
        <header class="header">
            ...
            <!-- header profile -->
            <div class="profile">@yield('header')
                <div class="image">
                    <a href="#">
                        <img src="{{asset('theme/images/profile.png')}}" alt="Ryan Adlard">
                    </a>
                </div>
        ...
        <div class="card-started" id="home-card">
            ...
            <div class="profile">
                ...
                <!-- profile photo -->
                <div class="image">
                    <img src="{{asset('theme/images/profile.png')}}" alt="" />
                </div>
                    ...
                    <div class="row client-items">
                            ...
                            <div class="client-item">
                                <div class="image">
                                    <a target="_blank" href="https://www.google.com/">
                                        ...
                                        <img src="{{asset('theme/images/clients/client_1.png')}}" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col col-d-3 col-t-3 col-m-6 border-line-v">
                            <div class="client-item">
                                <div class="image">
                                    <a target="_blank" href="https://www.google.com/">
                                        <img src="{{asset('theme/images/clients/client_2.png')}}" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col col-d-3 col-t-3 col-m-6 border-line-v">
                            <div class="client-item">
                                <div class="image">
                                    <a target="_blank" href="https://www.google.com/">
                                        <img src="{{asset('theme/images/clients/client_3.png')}}" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col col-d-3 col-t-3 col-m-6 border-line-v">
                            <div class="client-item">
                                <div class="image">
                                    <a target="_blank" href="https://www.google.com/">
                                        <img src="{{asset('theme/images/clients/client_4.png')}}" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="owl-carousel">
                                    <div class="item">
                                        <div class="revs-item">
                                            ...
                                            <div class="user">
                                                <div class="img"><img src="{{asset('theme/images/man1.jpg')}}" alt="" /></div>
                                                <div class="info">
                ...
                <div class="content works">
                    ...
                    <div class="row grid-items border-line-v">
                        ...
                        <div class="col col-d-6 col-t-6 col-m-12 grid-item photo border-line-h">
                            <div class="box-item">
                                <div class="image">
                                    <a href="{{asset('theme/images/works/work1.jpg')}}" class="has-popup-image">
                                        <img src="{{asset('theme/images/works/work1.jpg')}}" alt="" />
                                        <span class="info">
                            ...
                            <div class="box-item">
                                <div class="image">
                                    <a href="https://vimeo.com/97102654" class="has-popup-video">
                                        <img src="{{asset('theme/images/works/work2.jpg')}}" alt="" />
                                        <span class="info">
                            ...
                            <div class="box-item">
                                <div class="image">
                                    <a href="https://w.soundcloud.com/player/?visual=true&amp;url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F221650664&amp;show_artwork=true" class="has-popup-music">
                                        <img src="{{asset('theme/images/works/work3.jpg')}}" alt="" />
                                        <span class="info">
